...
public class Winplay {
    ...
    public Winplay() {
        ...
        System.out.println("Ты угода! Радостно сказала девочка и оттуда выскочили котики. Порывшись на дне коробки она выталила пистолет и протянула его вам. Вы очень увидивись когда вытащив обойму увидили боевые патроны.\n Спасибо - сказали вы. Но девочке уже было все равно и она начала играть с котиками.");
